...
const TRANSLATIONS: Record<Lang, TranslationKeys> = {
  ko: {
    ...
    brand_name: "플라잉재팬",
    footer_company: "플라잉재팬 주식회사",
    footer_address: "오사카시 중앙구",
    footer_phone: "06-1234-5678",
    copyright: "© Flying Japan Inc.",
  ...
  en: {
    ...
    footer_company: "Flying Japan Inc.",
    footer_address: "Chuo-ku, Osaka",
    footer_phone: "06-1234-5678",
    copyright: "© Flying Japan Inc.",
  ...
  ja: {
    ...
    footer_company: "フライングジャパン株式会社",
    footer_address: "大阪市中央区",
    footer_phone: "06-1234-5678",
    copyright: "© Flying Japan Inc.",
