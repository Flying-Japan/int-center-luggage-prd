            ...
            document.querySelectorAll('.price-cell').forEach(function(cell){
              cell.addEventListener('click',function(e){
                ...
                pop.innerHTML=
                  ...
                  '<label>Flying Pass<select name="tier"><option value="NONE"'+(tier==='NONE'?' selected':'')+'>없음</option><option value="BLUE"'+(tier==='BLUE'?' selected':'')+'>블루 (¥200)</option><option value="SILVER"'+(tier==='SILVER'?' selected':'')+'>실버 (¥300)</option><option value="GOLD"'+(tier==='GOLD'?' selected':'')+'>골드 (¥400)</option><option value="PLATINUM"'+(tier==='PLATINUM'?' selected':'')+'>플래티넘 (¥500)</option><option value="BLACK"'+(tier==='BLACK'?' selected':'')+'>블랙 (무료)</option></select></label>'+
