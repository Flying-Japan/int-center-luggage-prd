  ...
  return c.html(
    <html lang={lang}>
      <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-DLK6F3C7C6" />
        <script dangerouslySetInnerHTML={{__html: "window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-DLK6F3C7C6');"}} />
